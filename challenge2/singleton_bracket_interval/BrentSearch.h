...
public:
    BrentSearch(const ScalarFunction &f, Real a, Real b, Real tol = 1.e-5,
...
BrentSearch::BrentSearch(const ScalarFunction &f, Real a, Real b, Real tol,
                         iterType maxIter)
                         : BaseSolver(f),m_a(a),m_b(b),m_tol(tol),m_maxIt(maxIter) {}
